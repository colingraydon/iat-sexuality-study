  ...
  function iatExtension(options) {
    ...
    var iatObj = {
      ...
      instAttributePractice:
        ...
        'TEST TEST left finger TEST on the <b>E</b> key for items that belong to the category <font color="#0000ff">leftAttribute.</font>' +
      ...
      instAttributePracticeTouch: [
        ...
        "<br/>",
        'TEST TEST left finger TEST over the the <b>left</b> green area for items that belong to the category <font color="#0000ff">leftAttribute</font>.<br/>',
      ...
      instCategoriesPractice:
        ...
        '<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
        '<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
        'TEST TEST left finger TEST on the <b>E</b> key for items that belong to the category <font color="#336600">leftCategory</font>. ' +
      ...
      instCategoriesPracticeTouch: [
        ...
        '<p align="left" style="margin-left:5px">',
        "<br/>",
        'TEST TEST left finger TEST over the <b>left</b> green area for items that belong to the category <font color="#336600">leftCategory</font>.<br/>',
      ...
      instFirstCombinedTouch: [
        ...
        "<br/>",
        '<p align="left" style="margin-left:5px">',
        'TEST TEST left finger TEST over the <b>left</b> green area for <font color="#336600">leftCategory</font> items and for <font color="#0000ff">leftAttribute</font>.</br>',
      ...
      instSwitchCategoriesTouch: [
        ...
        'TEST TEST left finger TEST over the <b>left</b> green area for <font color="#336600">leftCategory</font> items.<br/>',
